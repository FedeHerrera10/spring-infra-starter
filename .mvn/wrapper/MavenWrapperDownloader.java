...
public class MavenWrapperDownloader {
    ...
    private static final String PROPERTIES_FILE = ".mvn/wrapper/maven-wrapper.properties";

    public static void main(String[] args) {
        try {
            Properties properties = new Properties();
            try (InputStream is = Files.newInputStream(Paths.get(PROPERTIES_FILE))) {
                properties.load(is);
            }
            ...
            Path target = Paths.get(".mvn/wrapper/maven-wrapper.jar");
            ...
            System.out.println("Maven wrapper downloaded to " + target);
        } catch (IOException e) {
