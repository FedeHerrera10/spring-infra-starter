 ...
 * Se deja abstracto para que el proyecto final lo herede con su entidad de
 * usuario.
 */
@RequiredArgsConstructor
@RequestMapping("/api/v1/auth/google")
@Tag(name = "AuthGoogle", description = "Endpoints de autenticación con Google")
public abstract class BaseGoogleAuthController<T extends BaseUser, V extends BaseVerificationToken> {
    ...
    @Operation(summary = "Iniciar sesión con Google", description = "Autentica a un usuario utilizando un token de identificación de Google")
    @ApiResponses(value = {
